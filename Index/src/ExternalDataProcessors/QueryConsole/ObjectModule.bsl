...
//
// ВнешниеОбработки.Создать("C:\QueryConsole.epf", Ложь).ОбработатьВнешнийЗапрос(Запрос, "РезультатыЗапроса");
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Функция ОбработатьВнешнийЗапрос(Знач Запрос = Неопределено, ИмяФайла = "РезультатыЗапроса") Экспорт
	...
	// Обработка.QueryConsole.МодульОбъекта Возможно ошибочное свойство: "ИспользуемоеИмяФайла"
